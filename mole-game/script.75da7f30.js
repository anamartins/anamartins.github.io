...
function chooseRandomHole() {
  ...
  var hole = document.querySelector("[data-number=\"".concat(randomNumber, "\"]"));
...
function insertMole(num) {
  var hole = document.querySelector("[data-number=\"".concat(num, "\"]"));
  var img = document.createElement("img");
  hole.appendChild(img);
  isKing(num);
  setMoleHungry(num);
  setTimeout(function () {
    return setMoleSad(num);
  }, 2000);
  setTimeout(function () {
    return setMoleLeaving(num);
  }, 2500);
  setTimeout(function () {
    return removeMole(num);
  }, 3000);
}
...
function setMoleHungry(num) {
  ...
  var mole = document.querySelector("[data-number=\"".concat(num, "\"] img"));
...
function showCongrats() {
  ...
  var div = document.querySelector(".winner");
  div.style.visibility = "visible";
  var button = document.querySelector(".winner-item button");
